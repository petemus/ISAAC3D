...
{
	// 1) physics 기반 이동 character면 -> AddImpulse() 사용
	// 2) 일반적인 등속 이동 character -> LaunchCharacter() 적당
	// XY축의 속도 무시, Z축 속도 무시 
...
void APlayerCharacter::Fire(const FInputActionValue& Value)
{
	...
	// TODO : tick() 보다 timer 사용이 더 효율적
	// 공격시 bCanAttack을 체크하고 timer로 몇초 후에 상태 돌리기
	// +) Animation이 중요한 곳에서는 notify로도 많이 처리하는 듯 
	switch (MyAttackMode)
	{
